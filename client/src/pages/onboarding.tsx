...
export default function Onboarding() {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      case 1: return profile.name && profile.name.length > 0;
      case 2: return profile.age && profile.age > 0;
      case 3: return profile.height && profile.height > 0;
      case 4: return profile.weight && profile.weight > 0;
      case 5: return profile.targetWeight && profile.targetWeight > 0;
      case 6: return profile.gender !== undefined;
      case 7: return profile.exerciseLevel !== undefined;
      case 8: return true; // Diet preferences are optional
  ...
  const renderStepContent = () => {
    switch (currentStep) {
        ...
        return (
          <div className="space-y-4">
            ...
            <Input
              ...
              onChange={(e) => updateProfile('targetWeight', parseInt(e.target.value) || 0)}
              className="rounded-2xl"
            />
          </div>
        );
      ...
      case 7:
        return (
          <div className="space-y-4">
            ...
            <Select value={profile.exerciseLevel} onValueChange={(value) => updateProfile('exerciseLevel', value)}>
              <SelectTrigger className="rounded-2xl">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      case 8:
        const dietOptions = ['none', 'vegetarian', 'vegan', 'halal', 'kosher', 'gluten_free', 'dairy_free'];
        return (
          <div className="space-y-4">
              ...
              {dietOptions.map((diet) => (
                <div key={diet} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleDietToggle(diet, checked as boolean)}
                  />
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                >
                  {currentStep === TOTAL_STEPS ? t('onboarding.finish') : t('onboarding.continue')}
